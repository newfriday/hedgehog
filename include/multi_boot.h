 ...
 * function:multiboot relation,header file
 * log:8.6.2019 first create this file
*/
...
}multiboot_info, *p_multiboot_info;
...
typedef struct multiboot_mmap {
	...
	U64 length;
	U32 type;
}__attribute__((packed)) multiboot_mmap, *p_multiboot_mmap;
